...
/**
 * This trait models expressions used in the SDQL language, without also computing them. It can be used to generate an
...
/**
 * This class models a symbol, e.g. "x1" or "x2", and it also includes options to get a fresh symbol, or to reset the
 * used symbol counter (start over from x1).
 */
 ...
 * @param values
 *   a sequence of expression values with a field label
 */
 ...
 * @param map
 *   a dictionary from expression to other expressions
 */
...
/**
 * This object models a sequence of let bindings, where the bindings can either be applied in an expression body, or
 * unapplied and returned from a given expression.
 */
object LetBindingN {
