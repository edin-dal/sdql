...
case class Update(accessors: Seq[Exp], inner: Exp, agg: Aggregation) extends Exp with LLQL
case class Modify(accessors: Seq[Exp], inner: Exp)                   extends Exp with LLQL
